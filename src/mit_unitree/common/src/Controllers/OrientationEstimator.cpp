...
void VectorNavOrientationEstimator<T>::run()
{
  ...
  //             << " 1: " << this->_stateEstimatorData.result->orientation[1]
  //             << " 2: " << this->_stateEstimatorData.result->orientation[2]
  //             << " 3: " << this->_stateEstimatorData.result->orientation[3] << std::endl;
  ...
  this->_stateEstimatorData.result->aBody = this->_stateEstimatorData.vectorNavData->accelerometer.template cast<T>();
  this->_stateEstimatorData.result->aWorld =
      this->_stateEstimatorData.result->rBody.transpose() * this->_stateEstimatorData.result->aBody;
}
