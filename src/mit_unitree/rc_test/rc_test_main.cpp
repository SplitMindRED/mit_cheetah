...
const char* switch_names[3] = { "UP", "--", "DN" };
...
void print_sbus(Taranis_X7_data& data)
{
  printf("\n\n\n"
         ...
         "  [%s]  [%s]  [%4.1f]  [%4.1f]  [%s]  [%s]\n"
         "         [%4.1f %4.1f]  [%4.1f %4.1f]\n",
         switch_names[(uint32_t)data.left_upper_switch], switch_names[(uint32_t)data.right_upper_switch],
         switch_names[(uint32_t)data.left_lower_left_switch], switch_names[(uint32_t)data.left_lower_right_switch],
         data.knobs[0], data.knobs[1], switch_names[(uint32_t)data.right_lower_left_switch],
         switch_names[(uint32_t)data.right_lower_right_switch], data.left_stick[0], data.left_stick[1],
